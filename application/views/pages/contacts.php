...
<section class="my-5">
  ...
  <div class="row">
    ...
    <div class="col-lg-7">
      ...
      <!--Google map-->
      <div id="map-container-section" class="z-depth-1-half map-container-section mb-8" style="height: 100%">
        <iframe width="100%" height="100%"  src="https://maps.google.com/maps?q=Manhatan&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0"
