        ...
        <form action="<?php echo base_url(); ?>index.php/loginMe" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-8 col-lg-offset-2" >
              ...
              <a href="<?php echo base_url( ) . 'index.php/register' ?>" class="btn btn-primary btn-block btn-flat"  >Register</a>
              <a href="<?php echo base_url( ) . 'index.php' ?>" class="btn btn-primary btn-block btn-flat"  >Homepage</a>
            </div><!-- /.col -->
          </div>
        </form>
