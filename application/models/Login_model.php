...
class Login_model extends CI_Model
{
     ...
     */
    function loginMe( $Id, $email, $password, $username, $register_select_role )
    {

        $query = $this->db->query("SELECT Id, email, password, username, register_select_role  FROM tbl_users");

        foreach ( $query->result() as $key => $row )
        {
          if ( in_array( $email, (array)$row->email ) )
          {
            $array[] = $row;
          }
